 ...
 * This file demonstrates how to integrate Aavelend with a web frontend
 */

// For React/Vue/Angular applications
export class AavelendClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AavelendClient(provider, contractAddress);
